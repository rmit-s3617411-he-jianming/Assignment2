...
class DataAdd extends JDialog implements ActionListener
{
   ...
   public DataAdd(Frame fck,String ckm,Boolean msck)
   {
	   super(fck,ckm,msck);
	   bq1=new JLabel("               Name       ");
   ...
   public void actionPerformed(ActionEvent e)
   {
	   if(e.getActionCommand().equals("tianjia2"))
	   {
		   ...
		   try {
				  ...
				  String ss=("insert into children values(?,?,?,?,?,?)");
