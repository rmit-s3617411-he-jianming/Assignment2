...
class DataModify extends JDialog implements ActionListener
{
   ...
   public DataModify(Frame fck,String ckm,Boolean msck,DataBase xsxx2,int hang)
   {
	   super(fck,ckm,msck);
	   bq1=new JLabel("               Name       ");
	   bq2=new JLabel("               Image      ");
	   bq3=new JLabel("               Status     ");
	   bq4=new JLabel("               Age        ");
	   bq5=new JLabel("               Gender     ");
	   bq6=new JLabel("               States     ");
   ...
   public void actionPerformed(ActionEvent e)
   {
	   if(e.getActionCommand().equals("xiugai"))
	   {
		   ...
		   try {
				  ...
				  String ss=("update children set Name=?,Image=?,Status=?,Age=?,Gender=? where Name=?");
